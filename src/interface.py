...
from src.interfaces.empty import Empty
...
from src.interfaces.modify import Modify
from src.exceptions import ProgramInterrupt, StateError
...
class Interface:
    ...
    def instanciate(self):
        ...
        if not self.is_instanciated:
            ...
            port = random.randint(53000, 53200)

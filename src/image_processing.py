...
def muscle_mask(hu_image):
    ...
    mask = (hu_image < threshold_min - min_value) | (hu_image > threshold_max - min_value)
...
def measurements(hu_image, prediction, pixel_spacing):
    ...
    mask = (thresholded_image < threshold_min - min_value) | (thresholded_image > threshold_max - min_value)
